...
RUN apt-get -y install apache2 libapache2-mod-php php php-dev php-cgi php-cli php-curl php-fpm php-json php-mbstring php-xml php-zip php-imagick php-pear php-mysql unzip libaio-dev
RUN apt-get -y clean
